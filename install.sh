...
echo "Copying files"
chmod +x buddybox buddyboxUI.py logger bb-pause bb-next bb-prev bb-fade bb-track
cp buddybox buddyboxUI.py logger bb-pause bb-next bb-prev bb-fade bb-track /usr/local/bin/
